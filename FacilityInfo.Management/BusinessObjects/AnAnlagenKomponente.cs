...
namespace FacilityInfo.Anlagen.BusinessObjects
{
    ...
    public class AnAnlagenKomponente : BaseObject
    {
        ...
        public AnKomponente Komponente
        {
            ...
            set
            {
                SetPropertyValue("Komponente", ref _komponente, value);
            }
        }
