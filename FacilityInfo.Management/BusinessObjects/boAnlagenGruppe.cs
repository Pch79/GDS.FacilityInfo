...
namespace FacilityInfo.Anlagen.BusinessObjects
{
    ...
    [ImageName("interface_preferences")]
    [XafDefaultProperty("Bezeichnung")]
    //Elektro/Heizung/Sanitär/Klima/Entwässerung
    public class boAnlagenGruppe : BaseObject
    {
        ...
        public boAnlagenGruppe(Session session)
            : base(session)
        {
        }
        ...
        [Association("boAnlagengruppe-boAnlagenart"), DevExpress.ExpressApp.DC.Aggregated]
