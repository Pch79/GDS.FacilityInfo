...
namespace FacilityInfo.Online.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class OnlineAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private GDS.FacilityInfo.Module.FacilityInfoModule module3;
        private FacilityInfo.Online.Module.Web.OnlineAspNetModule module4;
        ...
        #endregion
        public OnlineAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void OnlineAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new FacilityInfo.Online.Module.Web.OnlineAspNetModule();
            ...
            this.managementModule1 = new FacilityInfo.Management.ManagementModule();
            ...
            // 
            // OnlineAspNetApplication
            // 
            this.ApplicationName = "FacilityInfo.Online";
            ...
            this.Modules.Add(this.managementModule1);
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.OnlineAspNetApplication_DatabaseVersionMismatch);
