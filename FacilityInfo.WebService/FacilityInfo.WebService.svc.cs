...
namespace FacilityInfo.WebService
{
    public class FacilityInfoContext : XpoContext
    {
        public FacilityInfoContext(string s1, string s2, IDataLayer dataLayer)
    ...
    [JSONPSupportBehavior]
#endif
    public class FacilityInfoService : XpoDataServiceV3
    {
        static readonly FacilityInfoContext serviceContext = new FacilityInfoContext("FacilityInfo.WebServiceService", "FacilityInfo.WebService.FacilityInfo_Data", CreateDataLayer());

        public FacilityInfoService() : base(serviceContext, serviceContext) { }

        static IDataLayer CreateDataLayer()
        {
            DevExpress.Xpo.Metadata.XPDictionary dict = new DevExpress.Xpo.Metadata.ReflectionDictionary();
			dict.GetDataStoreSchema(typeof(FacilityInfoService).Assembly);
			IDataLayer dataLayer = new ThreadSafeDataLayer(dict, global::FacilityInfo.WebService.FacilityInfo_Data.ConnectionHelper.GetConnectionProvider(DevExpress.Xpo.DB.AutoCreateOption.SchemaAlreadyExists));
