...
namespace FacilityInfo.WebService.FacilityInfo_Data
{
    ...
    public partial class boCheckItemKategorie : XPCustomObject
    {
        Guid fOid;
        [Key(true)]
        public Guid Oid
        ...
        public XPCollection<boCheckItem> boCheckItems { get { return GetCollection<boCheckItem>("boCheckItems"); } }
    }
