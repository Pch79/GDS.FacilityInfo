...
namespace GDS.KwpAddOns.KwpData72.KwpDataModel.BNWINS_Demo_new
{
    ...
    public partial class RegiePos : XPBaseObject
    {
        string fPosKey;
        [Indexed(Name = @"IX_RegiePosPosKey", Unique = true)]
        [Size(65)]
        ...
        string fPosUNr;
        [Indexed(Name = @"IX_RegiePosPosUNr")]
        [Size(6)]
        ...
        string fPosSaKZ;
        [Indexed(Name = @"IX_RegiePosPosSaKZ")]
        [Size(1)]
        ...
        string fPosSaSZ;
        [Indexed(Name = @"IX_RegiePosPosSaSZ")]
        [Size(1)]
        ...
        string fPosZsKZ;
        [Indexed(Name = @"IX_RegiePosPosZsKZ")]
        [Size(1)]
        ...
        Regie fRefRegieEntry;
        [Size(15)]
        [Association(@"RegiePosReferencesRegie")]
        public Regie RefRegieEntry
        {
            get { return fRefRegieEntry; }
            set { SetPropertyValue<Regie>("RefRegieEntry", ref fRefRegieEntry, value); }
        }
    }
