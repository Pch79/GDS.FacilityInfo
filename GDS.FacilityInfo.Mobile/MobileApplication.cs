...
namespace GDS.FacilityInfo.Mobile {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class FacilityInfoMobileApplication : MobileApplication {
        ...
        private GDS.FacilityInfo.Module.Mobile.FacilityInfoMobileModule module4;
        ...
        public FacilityInfoMobileApplication() {
        ...
        private void FacilityInfoMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new GDS.FacilityInfo.Module.Mobile.FacilityInfoMobileModule();
            ...
            this.managementModule1 = new ManagementModule();
            this.globalObjectsModule1 = new GlobalObjectsModule();
            ...
            // 
            // FacilityInfoMobileApplication
            // 
            this.ApplicationName = "GDS.FacilityInfo";
            ...
            this.Modules.Add(this.globalObjectsModule1);
            this.Modules.Add(this.module3);
            this.Modules.Add(this.fileAttachmentsMobileModule);
            this.Modules.Add(this.reportsMobileModuleV2);
            this.Modules.Add(this.module4);
            this.Security = this.securityStrategyComplex1;
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.FacilityInfoMobileApplication_DatabaseVersionMismatch);
