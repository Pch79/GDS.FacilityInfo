...
namespace GDS.FacilityInfo.Web {
    ...
    public partial class FacilityInfoAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Module.FacilityInfoModule module3;
        private Module.Web.FacilityInfoAspNetModule module4;
        ...
        public FacilityInfoAspNetApplication() {
            InitializeComponent();
        ...
        private void FacilityInfoAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new GDS.FacilityInfo.Module.Web.FacilityInfoAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.FacilityInfoAspNetApplication_DatabaseVersionMismatch);
